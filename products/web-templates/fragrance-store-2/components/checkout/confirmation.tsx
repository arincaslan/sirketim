...
export function Confirmation({ orderNumber, email, total }: ConfirmationProps) {
  return (
    <motion.div
    ...
    >
      ...
      <div className="mt-3 w-full border border-primary/30 bg-primary/10 p-3 text-xs text-muted-foreground">
