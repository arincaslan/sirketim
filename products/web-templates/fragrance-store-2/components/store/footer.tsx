...
const FOOTER_LINKS = [
  ...
  },
  {
    heading: "Studio",
    links: [
      { href: "/about", label: "About Nocturne" },
      { href: "/cart", label: "Bag" },
  ...
  return (
    <footer className="border-t border-border bg-background">
      <div className="container grid gap-10 py-16 md:grid-cols-[1.3fr_1fr_1fr]">
        <div>
          <p className="font-display text-2xl font-semibold tracking-[0.08em]">
            NOCTURNE
          </p>
          <p className="mt-4 max-w-xs text-sm text-muted-foreground">
            Eleven fragrances built for after dark. Small batches, no
            reformulation between runs, no forty-note pyramids.
          </p>
        </div>
      ...
      <div className="border-t border-border">
        <div className="container flex flex-col gap-2 py-6 text-xs text-muted-foreground sm:flex-row sm:items-center sm:justify-between">
          <p>&copy; {new Date().getFullYear()} Nocturne. A Sirketim web template.</p>
