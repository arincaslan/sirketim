...
| Prices | Free (1 listing), Standard ($9.99/mo, $99/yr, 12 listings), Unlimited ($17.99/mo, $179/yr, uncapped). **Cut twice on 2026-09-18.** Standard went $19/$190 -> $12/$120 -> $9.99/$99, and the second cut took its allowance DOWN 25 -> 12 at the same time, so the ladder was reshaped rather than just discounted - twenty-five listings covered almost any real catalogue and left Unlimited selling a number nobody reaches. The top tier went $49/$490 -> $17.99/$179, narrowing the gap between the paid tiers from 4.1x to 1.8x. Founder's stated goal: "i want lots of subscribers". The `.99` endings are charm pricing, asked for explicitly. The top tier was called `Featured` until it was renamed after the one thing it does not buy. `lib/plans.ts` says in its own header these are **"a considered guess, not a price."** |
