...
| Dupe listings | **41 across 27 originals** (was 0; the 37 before that were invented and removed) — every one read off a live merchant feed, every pairing cited | ✅ |
| Working affiliate links | **39**, all traced and stock-checked (Opulensi 30, Clone of Perfume 9) | ✅ |
...
| Awin | Approved. **Opulensi (123248) earning since 1 Sep; Clone of Perfume (117395) approved 3 Sep — our first dupe house.** AromaPassions (34989) pending. My Perfume Shop (106089) stays closed for tracking. | ✅ |
| CJ Affiliate | **Network approved, and The Fragrance Shop approved us** — itself a dupe house (alcohol-free replications), so CJ is *not* originals-only as §3.3 assumed. Not yet wired. | ◐ wire it |
| Merchants we can actually earn from | **2 wired (Opulensi, Clone of Perfume) + 1 approved but unwired (The Fragrance Shop)** | ✅ |
| Revenue to date | **$0** | — |
...
| 3.3 ◐ | **Apply to CJ, then its fragrance advertisers** | **Updated 3 Sep: CJ approved us, and so did The Fragrance Shop — but it is not what this row predicted.** The claim below that **"CJ carries no dupe houses" is now false**: thefragranceshop.com states on its own site that *"the designer type fragrances available here are not the Designer originals, they are our own replications in concentrated form, completely free of alcohol"* — a dupe house, not an originals discounter. **Not yet wired**, and note the format difference before it is: these are alcohol-free **oil concentrates**, not EDP sprays, so longevity and sillage do not compare like-for-like with the rest of the catalog and any listing must say so plainly. Original note follows. ~~**CJ application submitted 31 Aug — pending CJ review.**~~ Once in, apply (priority order): **FragranceX** (advertiser ID 1024283 — category leader on CJ, ships worldwide, 1–10%), **Notino** (~5%, best for any EU/UK traffic), **Perfumania** (~4%, 15-day, US). Jomashop optional. All are *originals* discounters — CJ carries no dupe houses (Dossier is ShareASale→Awin; ALT./Oakcha run in-house programmes). CJ is the backup rail for the "buy the original" side, not a route to `DUPES` data. Company Payoneer account approved and earmarked for CJ payout. |
