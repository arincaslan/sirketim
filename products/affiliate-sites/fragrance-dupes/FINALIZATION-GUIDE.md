...
| Awin | Applied, verified/approved, payment configured (30 Aug). First merchant approved: My Perfume Shop (31 Aug) — **but its programme is CLOSED for tracking, verified 1 Sep: every link redirects to `closedMerchant.html`** | ❌ cannot earn |
| CJ Affiliate | **Application submitted 31 Aug — pending review** | ◐ |
| Merchants we can actually earn from | **0** | ❌ |
| Revenue to date | **$0** | — |
