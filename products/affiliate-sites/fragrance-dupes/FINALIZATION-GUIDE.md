...
5. ◐ **Open the company USD (*döviz*) account** — scheduled 28 Aug. *This is the top blocker.* Checked on 27 Aug: the company has none, and the USD account on record is personal. An A.Ş. invoice paid into a personal account will not survive review by the *mali müşavir*, and it cannot be fixed retroactively once payouts have started.
