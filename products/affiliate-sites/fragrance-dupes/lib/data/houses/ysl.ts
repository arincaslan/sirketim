...
export const YSL: ReferenceFragrance[] = [
  ...
  },
  {
    ...
    notes: {
      top: ["Mandarin", "Bergamot", "Coriander", "Clove"],
      heart: ["Carnation", "Jasmine", "Cinnamon", "Myrrh"],
      base: ["Vanilla", "Opoponax", "Patchouli", "Amber", "Benzoin"],
    },
    facets: { freshness: 2, sweetness: 7, warmth: 9, woodyDepth: 6, longevity: 8, sillage: 8 },
    longevityHoursRange: [7, 10],
    sillageLabel: "Beast Mode",
    priceUsd: 130,
    bottleMl: 90,
    concentration: "Eau de Parfum",
    affiliateLinkId: "original-opium",
  },
  {
    slug: "kouros",
    name: "Kouros",
    ...
    notes: {
      top: ["Aldehydes", "Bergamot", "Coriander", "Clary Sage"],
      heart: ["Carnation", "Cinnamon", "Jasmine", "Patchouli"],
      base: ["Civet", "Musk", "Leather", "Vetiver", "Honey"],
    },
    facets: { freshness: 5, sweetness: 4, warmth: 8, woodyDepth: 6, longevity: 8, sillage: 9 },
    longevityHoursRange: [7, 10],
    sillageLabel: "Beast Mode",
    priceUsd: 105,
    bottleMl: 100,
    concentration: "Eau de Toilette",
    affiliateLinkId: "original-kouros",
  },
  {
    slug: "tuxedo",
    name: "Tuxedo",
    ...
    facets: { freshness: 4, sweetness: 6, warmth: 7, woodyDepth: 7, longevity: 8, sillage: 7 },
