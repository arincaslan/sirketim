...
export const LE_LABO: ReferenceFragrance[] = [
  ...
  },
  {
    ...
    notes: {
      ...
      heart: ["Orange Blossom", "Vetiver"],
      base: ["Musk", "Amber", "Cedar"],
    },
    facets: { freshness: 9, sweetness: 3, warmth: 4, woodyDepth: 5, longevity: 6, sillage: 6 },
    longevityHoursRange: [5, 7],
    sillageLabel: "Moderate",
    priceUsd: 220,
    bottleMl: 50,
    concentration: "Eau de Parfum",
    affiliateLinkId: "original-bergamote-22",
  },
  {
    slug: "the-matcha-26",
    name: "The Matcha 26",
    ...
    family: "Green Woody",
    notes: {
      top: ["Matcha Tea", "Bitter Orange", "Fig"],
      heart: ["Jasmine", "Bay Leaf", "Orris"],
      base: ["Cedar", "Vetiver", "Musk"],
    },
    facets: { freshness: 8, sweetness: 3, warmth: 4, woodyDepth: 6, longevity: 6, sillage: 5 },
    longevityHoursRange: [5, 7],
    sillageLabel: "Moderate",
    priceUsd: 220,
    bottleMl: 50,
    concentration: "Eau de Parfum",
    affiliateLinkId: "original-the-matcha-26",
  },
];
