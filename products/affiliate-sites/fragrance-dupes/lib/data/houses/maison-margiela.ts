...
export const MAISON_MARGIELA: ReferenceFragrance[] = [
  ...
  },
  {
    ...
    facets: { freshness: 7, sweetness: 4, warmth: 4, woodyDepth: 3, longevity: 5, sillage: 5 },
    longevityHoursRange: [4, 6],
    sillageLabel: "Moderate",
    priceUsd: 160,
    bottleMl: 100,
    concentration: "Eau de Toilette",
    affiliateLinkId: "original-lazy-sunday-morning",
  },
  {
    slug: "sailing-day",
    name: "Sailing Day",
    ...
    notes: {
      top: ["Sea Salt", "Bergamot", "Juniper"],
      heart: ["Seaweed", "Marine Accord", "Coriander"],
      base: ["Musk", "Ambrette", "Woody Notes"],
    },
    facets: { freshness: 9, sweetness: 2, warmth: 3, woodyDepth: 4, longevity: 5, sillage: 5 },
    longevityHoursRange: [4, 6],
    sillageLabel: "Moderate",
    priceUsd: 160,
    bottleMl: 100,
    concentration: "Eau de Toilette",
    affiliateLinkId: "original-sailing-day",
  },
];
